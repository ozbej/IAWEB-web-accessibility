...
{\large
706.041 Information Architecture and Web Usability 3VU WS 2022/2023 \\
...
\cleardoublepage
\input{survey-introduction.tex}

\cleardoublepage
\input{survey-text-only-browsers}

\cleardoublepage
\input{survey-screen-readers}

\cleardoublepage
\input{survey-browser-extensions}

\cleardoublepage
\input{survey-web-tools}

\cleardoublepage
\input{survey-build-tools}
